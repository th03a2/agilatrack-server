...
import loftsGPSRouter from "./routes/loftsGPS.js";
import raceStationsRouter from "./routes/raceStations.js";
import raceComputationRouter from "./routes/raceComputation.js";
...
app.use("/api/lofts", loftsGPSRouter);
app.use("/api/race-stations", raceStationsRouter);
app.use("/api/races", raceComputationRouter);
